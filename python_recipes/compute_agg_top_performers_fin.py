# -*- coding: utf-8 -*-
"""
Recipe: agg_top_performers_fin   (FINISHING — mirror of agg_top_performers)
Inputs : fact_second_step, fact_fin_bc, fact_fin_ac, fact_nc_scrap
Output : agg_top_performers_fin
"""
...
bc    = dataiku.Dataset("fact_fin_bc").get_dataframe()
ac    = dataiku.Dataset("fact_fin_ac").get_dataframe()
...
print(f"agg_top_performers_fin rows: {len(agg):,}")
